...
var z = ds.exports;
const Ss = Mc(z),
  Zc = Ic({ __proto__: null, default: Ss }, [z]);
/**
 * @license React
 ...
 */ (function (e) {
  ...
  function r(C) {
    ...
    if (L !== T) {
      C[0] = L;
      e: for (var H = 0, Z = C.length, rr = Z >>> 1; H < rr; ) {
        var gt = 2 * (H + 1) - 1,
          Nl = C[gt],
          wt = gt + 1,
          lr = C[wt];
        if (0 > l(Nl, L))
          wt < Z && 0 > l(lr, Nl)
            ? ((C[H] = lr), (C[wt] = L), (H = wt))
            : ((C[H] = Nl), (C[gt] = L), (H = gt));
        else if (wt < Z && 0 > l(lr, L)) (C[H] = lr), (C[wt] = L), (H = wt);
        else break e;
      }
    }
    return T;
  ...
  function k(C, T) {
    ...
    try {
      for (
        d(T), p = n(s);
        p !== null && (!(p.expirationTime > T) || (C && !ze()));
      ...
      if (p !== null) var rr = !0;
        ...
        var gt = n(c);
        gt !== null && Pl(v, gt.startTime - T), (rr = !1);
      }
      return rr;
    } finally {
      (p = null), (m = L), (g = !1);
      ...
      return (
        ...
        L > H
          ? ((C.sortIndex = L),
            ...
            n(s) === null &&
              C === n(c) &&
              (S ? (f(N), (N = -1)) : (S = !0), Pl(v, L - H)))
          : ((C.sortIndex = Z), t(s, C), w || g || ((w = !0), _l(k))),
        C
      );
    }),
...
function en(e, t) {
  for (jn[e] = t, e = 0; e < t.length; e++) Ps.add(t[e]);
}
var Ke = !(
    typeof window > 'u' ||
...
function $s() {
  if (Yt) {
    var e = Yt,
      t = Xt;
    if (((Xt = Yt = null), lu(e), t)) for (e = 0; e < t.length; e++) lu(t[e]);
  }
}
function Bs(e, t) {
  return e(t);
...
function vf(e, t, n, r, l, o, i, u, s) {
  (Nn = !1), (jr = null), hf.apply(mf, arguments);
}
...
function Cr(e) {
  ...
  for (var t = e.targetContainers; 0 < t.length; ) {
    ...
    } else return (t = tr(n)), t !== null && ci(t), (e.blockedOn = n), !1;
    t.shift();
  }
  return !0;
}
...
function fi(e, t, n, r) {
  if ($r) {
    ...
    else if ((uu(e, r), t & 4 && -1 < Lf.indexOf(e))) {
      for (; l !== null; ) {
        var o = tr(l);
        if (
          (o !== null && Js(o),
...
var Br = null;
function So(e, t, n, r) {
  if (((Br = null), (e = ui(r)), (e = Et(e)), e !== null))
  ...
  sl = A({}, er, {
    ...
    movementX: function (e) {
      return 'movementX' in e
        ...
        : (e !== yn &&
            (yn && e.type === 'mousemove'
              ? ((Ml = e.screenX - yn.screenX), (jl = e.screenY - yn.screenY))
              : (jl = Ml = 0),
            (yn = e)),
          Ml);
    },
...
function yu() {
  Tn && (Tn.detachEvent('onpropertychange', aa), (An = Tn = null));
}
function aa(e) {
  if (e.propertyName === 'value' && al(An)) {
    var t = [];
    ua(t, An, e, ui(e)), Ws(sd, t);
  }
}
function cd(e, t, n) {
  e === 'focusin'
    ? (yu(), (Tn = t), (An = n), Tn.attachEvent('onpropertychange', aa))
    : e === 'focusout' && yu();
}
function fd(e) {
...
function Wn(e, t) {
  ...
  for (r = 0; r < n.length; r++) {
    var l = n[r];
    if (!to.call(t, l) || !je(e[l], t[l])) return !1;
  }
  return !0;
}
function gu(e) {
...
function cl(e) {
  ...
  var t = $t[e],
    n;
  for (n in t) if (t.hasOwnProperty(n) && n in da) return ($l[e] = t[n]);
  return e;
}
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v),
              f !== null && ((v = Fn(a, f)), v != null && S.push(Hn(a, v, d)))),
            x)
          )
            break;
          a = a.return;
...
function yt() {
  if (!Ql && We !== null) {
    ...
    try {
      ...
      throw (We !== null && (We = We.slice(e + 1)), Ks(si, yt), l);
    } finally {
      (M = t), (Ql = !1);
    }
  }
...
var Wt = [],
  ...
  He = '';
function St(e, t) {
  (Wt[Vt++] = Kr), (Wt[Vt++] = Qr), (Qr = e), (Kr = t);
}
function Ea(e, t, n) {
  (Ee[xe++] = Ve), (Ee[xe++] = He), (Ee[xe++] = zt), (zt = e);
  var r = Ve;
  e = He;
  var l = 32 - Ie(r) - 1;
  (r &= ~(1 << l)), (n += 1);
...
function gi(e) {
  for (; e === Qr; )
    (Qr = Wt[--Vt]), (Wt[Vt] = null), (Kr = Wt[--Vt]), (Wt[Vt] = null);
  for (; e === zt; )
    (zt = Ee[--xe]),
      (Ee[xe] = null),
      (He = Ee[--xe]),
...
function Io(e, t, n, r) {
  var l = e.stateNode;
  (l.props = n), (l.state = e.memoizedState), (l.refs = Na), Ci(e);
  var o = t.contextType;
  typeof o == 'object' && o !== null
    ? (l.context = Pe(o))
...
function Ta(e) {
  ...
  function m(f, a, d, v) {
    ...
    if (typeof d == 'object' && d !== null) {
      switch (d.$$typeof) {
        ...
        case qe:
          return (k = d._init), m(f, a, k(d._payload), v);
      }
  ...
  function w(f, a, d, v) {
    for (
      var k = null, _ = null, P = a, N = (a = 0), V = null;
      P !== null && N < d.length;
      N++
    ) {
    ...
    if (N === d.length) return n(f, P), U && St(f, N), k;
    if (P === null) {
      for (; N < d.length; N++)
        (P = p(f, d[N], v)),
          P !== null &&
  ...
  function S(f, a, d, v) {
    ...
    for (
      var _ = (k = null), P = a, N = (a = 0), V = null, O = d.next();
      P !== null && !O.done;
      N++, O = d.next()
    ) {
      P.index > N ? ((V = P), (P = null)) : (V = P.sibling);
      var ze = m(f, P, O.value, v);
      if (ze === null) {
        P === null && (P = V);
        break;
      }
    ...
    if (O.done) return n(f, P), U && St(f, N), k;
    if (P === null) {
    ...
    if (
      ...
      switch (d.$$typeof) {
        ...
        case jt:
          ...
          return i(f);
        case qe:
          return (_ = d._init), x(f, a, _(d._payload), v);
      }
...
function _i(e, t) {
  switch ((j(Gn, t), j(Kn, e), j(Be, nr), (e = t.nodeType), e)) {
    case 9:
    case 11:
...
function Ia(e, t) {
  ...
  if (
    ...
    (r = r.queue),
    Ri(Da.bind(null, n, r, e), [e]),
    r.getSnapshot !== t || o || (J !== null && J.memoizedState.tag & 1))
  ) {
    if (
      ((n.flags |= 2048),
      Zn(9, ja.bind(null, n, r, l, t), void 0, null),
      q === null)
    )
      throw Error(y(349));
    Tt & 30 || Ma(n, t, l);
...
function Va(e, t, n) {
  return (
    (n = n != null ? n.concat([e]) : null), hl(4, 4, Wa.bind(null, t, e), n)
  );
}
function Oi() {}
function Ha(e, t) {
...
function Ka(e, t, n) {
  return Tt & 21
    ? (je(n, t) || ((n = Xs()), (B.lanes |= n), (Lt |= n), (e.baseState = !0)),
      t)
...
function Od(e, t, n) {
  ...
  if (Ya(e)) Xa(t, l);
    ...
    (n = _a(e, t, l, r)),
      n !== null && ((l = ue()), Me(n, e, r, l), Za(n, t, r));
  }
}
function Ya(e) {
  var t = e.alternate;
  ...
  Id = {
    ...
    useImperativeHandle: function (e, t, n) {
      return (
        ...
        Tr(4194308, 4, Wa.bind(null, t, e), n)
      );
    },
    ...
    useSyncExternalStore: function (e, t, n) {
      ...
      return (
        (l.queue = o),
        Fu(Da.bind(null, r, o, e), [e]),
        (r.flags |= 2048),
        Zn(9, ja.bind(null, r, o, n, t), void 0, null),
        n
      );
    },
    useId: function () {
...
function Vu(e, t, n, r, l) {
  ...
  if ((Jt(t, l), t.stateNode === null))
    Lr(e, t), za(t, n, r), Io(t, n, r, l), (r = !0);
  else if (e === null) {
    var i = t.stateNode,
      u = t.memoizedProps;
    i.props = u;
    ...
    u !== p || m !== w || de.current || be
      ? (typeof g == 'function' && (Oo(t, n, g, r), (w = t.memoizedState)),
        (c = be || Iu(t, n, c, r, m, w, s) || !1)
          ? (h ||
...
function Do(e, t, n, r, l, o) {
  tc(e, t);
  var i = (t.flags & 128) !== 0;
  if (!r && !i) return l && zu(t, n, !1), Xe(e, t, o);
...
function Ud(e, t, n, r, l, o, i) {
  if (n)
    return t.flags & 256
      ? ((t.flags &= -257), (r = Zl(Error(y(422)))), gr(e, t, i, r))
      : t.memoizedState !== null
  ...
  if (l.data === '$!') {
    ...
    return (r = u), (o = Error(y(419))), (r = Zl(o, r, void 0)), gr(e, t, i, r);
  }
  if (((u = (i & e.childLanes) !== 0), fe || u)) {
    ...
    return $i(), (r = Zl(Error(y(421)))), gr(e, t, i, r);
  }
  return l.data === '$?'
    ? ((t.flags |= 128),
      (t.child = e.child),
  ...
  switch ((gi(t), t.tag)) {
    ...
    case 6:
      if (e && t.stateNode != null) uc(e, t, e.memoizedProps, r);
        ...
        if (((n = Ct(Gn.current)), Ct(Be.current), vr(t))) {
          if (
            ((r = t.stateNode),
            (n = t.memoizedProps),
            (r[Ue] = t),
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            ...
            ((t.child.flags |= 8192),
            t.mode & 1 &&
              (e === null || $.current & 1 ? X === 0 && (X = 3) : $i())),
          t.updateQueue !== null && (t.flags |= 4),
          re(t),
          null);
    case 4:
      return (
        ln(), $o(e, t), e === null && Vn(t.stateNode.containerInfo), re(t), null
      );
    case 10:
...
function Vd(e, t) {
  ...
  for (Co = { focusedElem: e, selectionRange: n }, $r = !1, E = t; E !== null; )
...
function dc(e, t, n) {
  for (var r = (e.mode & 1) !== 0; E !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && o !== null ? ((o.return = l), (E = o)) : Xu(e);
  }
}
function Xu(e) {
  for (; E !== null; ) {
...
function Me(e, t, n, r) {
  if (50 < Mn) throw ((Mn = 0), (Qo = null), Error(y(185)));
  bn(e, n, r),
    (!(I & 2) || e !== q) &&
      (e === q && (!(I & 2) && (vl |= n), X === 4 && tt(e, ee)),
      he(e, r),
...
function he(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && iu(n), t === 1))
      e.tag === 0 ? Nd(qu.bind(null, e)) : ka(qu.bind(null, e)),
        xd(function () {
          !(I & 6) && yt();
        }),
        (n = null);
...
function pc(e, t) {
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = Jn), _t(e, 0), tt(e, r), he(e, Q()), n);
    if (t === 6) tt(e, r);
    else {
      if (
...
function qu(e) {
  ...
  if (n === 1) throw ((n = Jn), _t(e, 0), tt(e, t), he(e, Q()), n);
...
function _t(e, t) {
  ...
  if ((n !== -1 && ((e.timeoutHandle = -1), Ed(n)), G !== null))
...
function $i() {
  (X === 0 || X === 3 || X === 2) && (X = 4),
    q === null || (!(Lt & 268435455) && !(vl & 268435455)) || tt(q, ee);
}
function nl(e, t) {
  var n = I;
  I |= 2;
  ...
  while (!0);
  if ((ki(), (I = n), (br.current = r), G !== null)) throw Error(y(261));
...
function Zd(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    q === e &&
      (ee & n) === n &&
      (X === 4 || (X === 3 && (ee & 130023424) === ee && 500 > Q() - Di)
        ? _t(e, 0)
        : (ji |= n)),
    he(e, t);
}
...
wc = function (e, t, n) {
  ...
  else (fe = !1), U && t.flags & 1048576 && Ea(t, Kr, t.index);
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            Io(t, r, e, n),
            (t = Do(null, t, r, !0, o, n)))
          : ((t.tag = 0), U && o && yi(t), ie(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
...
function lp(e, t, n, r, l) {
  ...
  var s = Ai(e, 0, !1, null, null, !1, !1, '', ts);
  return (
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (ai(t, n | 1), he(t, Q()), !(I & 6) && ((un = Q() + 500), yt()));
      }
      break;
    case 13:
      Rt(function () {
...
Bs = Fi;
As = Rt;
var op = { usingClientEntryPoint: !1, Events: [tr, Bt, fl, Us, $s, Fi] },
  Sn = {
...
function cp(e, t, n, r) {
  ...
  function p() {
    ...
    let x = h(),
      f = x == null ? null : x - c;
    (c = x), s && s({ action: u, location: S.location, delta: f });
  }
  function m(x, f) {
    u = lt.Push;
    let a = Yo(S.location, x, f);
    n && n(a, x), (c = h() + 1);
    let d = ls(a, c),
      v = S.createHref(a);
    try {
...
function Pc(e, t, n, r) {
  ...
  return (
    e.forEach((o, i) => {
      ...
      else for (let s of Nc(o.path)) l(o, i, s);
    }),
    t
  );
}
...
function Ep(e, t) {
  ...
  return {
    params: r.reduce((c, h, p) => {
      ...
      const w = u[p];
      return g && !w ? (c[m] = void 0) : (c[m] = _p(w || '', m)), c;
    }, {}),
    pathname: o,
    pathnameBase: i,
    pattern: e,
...
function Rp() {
  return Ki() || me(!1), z.useContext(xl).location;
}
function Op(e, t) {
  return Ip(e, t);
}
function Ip(e, t, n, r) {
  ...
  if (t) {
    ...
    s === '/' || ((p = x.pathname) != null && p.startsWith(s)) || me(!1),
      (h = x);
  } else h = c;
  let m = h.pathname || '/',
...
function Up(e, t, n, r) {
  ...
  return i.reduceRight((h, p, m) => {
    ...
    n &&
      ...
      (S = p.route.errorElement || jp),
      s &&
        (c < 0 && m === 0
          ? (Vp('route-fallback', !1), (w = !0), (x = null))
          : c === m &&
  ...
  let {
    ...
    S = z.useMemo(() => {
      ...
      return x == null
        ? null
        : {
            location: { pathname: x, search: p, hash: m, state: g, key: w },
            navigationType: l,
          };
    }, [s, h, p, m, g, w, l]);
  return S == null
...
function Yp() {
  return K.jsx('div', {
    children:
      'We believe every company has a unique purpose and growth journey. Cloud empowers you to scale rapidly, seize emerging opportunities , and future-proof your business . With Cloud as the unifying digital fabric , you can take advantage of break-through technologies. We believe in building a unique cloud strategy that is customized at every stage. Our deep understanding on cloud migration knowledge and the power for modern data transformation make your enterprise future ready Our solutions Strategy (Box/Image) GBS provides a guided framework to design a cloud migration roadmap in alignment with enterprise business objectives using Private,Public and Hybrid cloud solutions. Foundation and Pre Assessment (Box/Image) GBS guides enterprises to define,design and deploy cloud foundation services by pre assessment and evaluating non-functional aspects such as security , cost management and continuous improvement Migration GBS helps enterprises redefine their transition strategy to ensure frictionless migration of applications to public and hybrid cloud through a resilient approach with minimal downtime for enterprise applications and services.',
  });
}
function Xp() {
  return K.jsx('div', {
    children:
      'Accelerate results with modern data driven insights .We believe delivering business outcomes by harnessing various data echo systems in near real time with a modern data-centric approach using modern data driven technologies and linking the data lineage to geospatial analytics Our solutions Geospatial Analytics [Box/Image] Today’s technologies—mobile devices, location sensors, social media, and more—allow organizations to collect time and place (“geo-referenced”) data about practically any event. But what are they doing with all that information? Geospatial analysis uses this data to build maps, graphs, statistics, and cartograms, making complex relationships understandable. Representations like these can reveal historical shifts, as well as those underway today. They can even point to those that are likely to occur in the future Sales and Marketing Analytics [Box/Image] Derive Hyper-personalized offers with data-driven analytical solutions Next-best action framework: Achieve hyper-personalization and customer experience enhancement through a dynamic recommendation engine Campaign optimizer: Maximize ROI and minimize costs Customer retention index: Integrate multiple objective evolutionary algorithms for customer retention by supporting proactive and reactive mitigation efforts Channel attribution: Allocate optimum marketing budgets across different channels Pricing optimizer: Support different risk-based and incentive-oriented pricing actions Logfile analyzer: Drive real-time prediction and prevention actions on user transactions Asset allocation framework: Enhance customer experience, maximize revenue, and minimize volatility of wealth portfolios with reusable algorithms or assets',
  });
}
function Zp() {
  return K.jsx('div', {
    children:
      'Technology consulting and Training [Image/description] Our solutions IOT & Digital Engineering [Image/description] Our solutions Product Development and Application Development Services [Image/Descriptions] Our solutions',
  });
}
function Jp() {
  return K.jsx('div', {
    children:
      'Global Biome Services., a Princeton based IT hub that provides IT Services, specialized in helping clients for Cloud migration , Data Transformation and developing products to provide data driven insights using Machine Learning and big data analytics We help increase ROI and business value for our clients through adapting Converged and Hyper Converged platforms and cloud enablement. GBS has a deep understanding of the advanced technologies and our experienced pool of IT resources mean that we have it in us to serve any client, anywhere on the globe. We deliver the value that clients care about; we provide ideas and solutions tailor-made to meet their needs and produce results of the highest quality.Our clients look forward to us for innovative ideas, expertise, and solutions that help them improve the entire gamut of their business.We believe in total commitment and better results for all our associates',
  });
}
function qp() {
  return K.jsxs(K.Fragment, {
    children: [
      K.jsx(Gp, {
        children: K.jsxs(Qp, {
          children: [
            K.jsx(_n, { path: '/', element: K.jsx(Jp, {}) }),
            K.jsx(_n, { path: '/cloud', element: K.jsx(Yp, {}) }),
            K.jsx(_n, { path: '/analytics', element: K.jsx(Xp, {}) }),
            K.jsx(_n, { path: '/consulting', element: K.jsx(Zp, {}) }),
          ],
        }),
      }),
      K.jsx('div', { className: 'flex-container' }),
      K.jsx('div', {
        className: 'card',
        children:
          'Extended teams GBS is committed to building and maintaining exceptional relationships with our clients and candidates. We have successfully helped many companies identify, interview and on-board talented professionals at all levels. We have strategy-insight driven methods to source professionals for the entire gamut of IT including excellently fitting Cloud Engineers, Project Managers, Business Analysts, Infrastructure Engineers and brilliant Techies for all verticals. We have Passionate and genuinely experienced software professionals with very high skill sets and competencies to take up any given tasks. GBS prioritizes on genuineness of our resources and provide them with equal opportunity to learn, grow and succeed For Employers We provide the right skills at the right price, right when you need it. Finding the right staff for your company is an exhaustive process. Once we understand your needs, we will provide you with carefully screened job candidates. Our supreme knowledge of the technology marketplace allows us to access the very best and brightest in the industry. We will provide you with top quality aspirants, tailored for your company needs and environment, allowing you to interview a select candidate and bring them on-board.We are provide resource to work onsite and remotely We recruit for your needs Our recruiting process is designed to find associates who can add business value in your organization from day one. Through our vast network of contacts, we have unmatched access to a pool of skilled individuals. We use proven and reliable job-related assessments to pinpoint candidates’ abilities and fit with your work environment. And, we work to build an in-depth understanding of your objectives to effectively match our associates to your needs.',
      }),
    ],
  });
}
eo.createRoot(document.getElementById('root')).render(
  K.jsx(Ss.StrictMode, { children: K.jsx(qp, {}) }),
);
