    ...
    <div>
      ...
      <div>
        ...
        <div className="MainServicePage">
          Nanosat undertakes a large-scale cloud migration
          ...
          <br />
          As data moves to the cloud, Nanosat establishes a secure,
          ...
          this cloud migration, Nanosat gains the flexibility,
